...
class biLSTM_CRF(nn.Module):
    ...
    def _viterbi_decode(self, feats):
        ...
        # forward_var at step i holds the viterbi variables for this step
        ...
        for feat in feats:
            ...
            # of viterbi variavkes we just comouted.
...
tag2ix = {"B":0, "I":1, "O":2, START_TAG:3, STOP_TAG:4}
...
for epoch in range(300):
    for sentence, tags in training_data:
        ...
        targets = torch.tensor([tag2ix[t] for t in tags])
